...
public class AppliTestBLL {
	...
	public static void main(String[] args) {
		...
		/*
		 * METHODE PROPOSEE DANS LA RESSOURCE EN TELECHARGEMENT :
		   try {
		 ...
		 * Je ne vois pas pourquoi le constructeur devrait renvoyer
		 * une exception dans ce cas, donc j'ai fait autrement...
		 */
